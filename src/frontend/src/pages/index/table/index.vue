            ...
            <el-form label-width="220px">
                ...
                <el-form-item label="需生成的Controller方法" v-if="isControllerChecked">
                    ...
                    <el-checkbox-group v-model="genSetting.choosedControllerMethods">
                        <el-checkbox :checked="true" label="list" key="list">列表查询</el-checkbox>
                        <el-checkbox :checked="true" label="getById" key="getById">按ID查询</el-checkbox>
                        <el-checkbox :checked="true" label="create" key="create">新增</el-checkbox>
                        <el-checkbox :checked="true" label="update" key="update">修改</el-checkbox>
                        <el-checkbox :checked="true" label="delete" key="delete">删除</el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
